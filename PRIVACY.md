...
MY MACHINE contains no analytics SDK, remote service, AI call, updater, push-notification service, or outbound network client. It never uploads telemetry, app-family rollups, or reports. Reports and local report-ready alerts work entirely offline. Detailed samples default to three days; daily summaries support longer trends. Export occurs only through an explicit Save action.
